...
const Hero = () => {
  return (
    <div className="hero bg-[#F9FAFA]">
      <div className="mx-[12.5%] grid md:grid-cols-2 grid-cols-1">
        <div>
          <h1
          ...
          <div className=" mt-5 flex flex-row gap-5">
            ...
            <button className=" hover:bg-[#c19f6110] transition-all flex flex-row gap-3 items-center text-[#C1A061] border border-[#C1A061] px-9 rounded-full font-sans font-medium">
